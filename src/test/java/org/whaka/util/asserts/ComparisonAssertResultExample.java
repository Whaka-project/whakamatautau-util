...
public class ComparisonAssertResultExample {
	...
	public static void main(String[] args) {
		...
		ComparisonResult customResult = jobPerformer.appl(racer, spy);
		ComparisonAssertResult customAssert = ComparisonAssertResult.createWithCause(customResult);
		
		ComparisonResult reflectiveResult = ComparisonPerformers.REFLECTIVE_EQUALS.appl(racer, spy);
		ComparisonAssertResult reflectiveAssert = ComparisonAssertResult.createWithCause(reflectiveResult);
		
		ComparisonResult basicResult = ComparisonPerformers.DEEP_EQUALS.appl(racer, spy);
		ComparisonAssertResult basicAssert = ComparisonAssertResult.createWithCause(basicResult);
		
		ComparisonResult numberResult = ComparisonPerformers.DOUBLE_MATH_EQUALS.appl(BigDecimal.TEN, BigInteger.ONE);
