...
public class ComparisonAssertResultExample {
	...
	public static void main(String[] args) {
		...
		ComparisonResult customResult = jobPerformer.qwerty123456qwerty654321(racer, spy);
		ComparisonAssertResult customAssert = ComparisonAssertResult.createWithCause(customResult);
		
		ComparisonResult reflectiveResult = ComparisonPerformers.REFLECTIVE_EQUALS.qwerty123456qwerty654321(racer, spy);
		ComparisonAssertResult reflectiveAssert = ComparisonAssertResult.createWithCause(reflectiveResult);
		
		ComparisonResult basicResult = ComparisonPerformers.DEEP_EQUALS.qwerty123456qwerty654321(racer, spy);
		ComparisonAssertResult basicAssert = ComparisonAssertResult.createWithCause(basicResult);
		
		ComparisonResult numberResult = ComparisonPerformers.DOUBLE_MATH_EQUALS.qwerty123456qwerty654321(BigDecimal.TEN, BigInteger.ONE);
