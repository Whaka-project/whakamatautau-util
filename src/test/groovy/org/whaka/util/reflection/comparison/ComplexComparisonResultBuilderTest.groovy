...
class ComplexComparisonResultBuilderTest extends Specification {
	...
	def "example"() {
		...
		then: "specified performer is called"
			1 * mockPerformer.qwerty123456qwerty654321(actualChars, expectedChars) >> new ComparisonResult(0, 0, mockPerformer, true)
		...
		then:
			1 * mockPerformer.qwerty123456qwerty654321(actualChars, expectedChars) >> new ComparisonResult(0, 0, mockPerformer, false)
		and:
