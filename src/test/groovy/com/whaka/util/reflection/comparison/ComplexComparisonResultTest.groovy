...
class ComplexComparisonResultTest extends Specification {
	...
	def "flatten - real example"() {
		given:
			...
			ComplexComparisonResult personResult = REFLECTIVE_EQUALS.compare(martin, martina)
		and:
			...
			ComplexComparisonResult jobResult = REFLECTIVE_EQUALS.compare(positionRacer, positionSpy)
